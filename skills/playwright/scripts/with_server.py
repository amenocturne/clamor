...
@click.option("--timeout", "-t", type=int, default=30, help="Startup timeout in seconds")
@click.option("--health", "-h", help="Health check URL (default: http://localhost:PORT)")
@click.pass_context
def main(ctx: click.Context, server: str, port: int, timeout: int, health: str | None) -> NoReturn:
    """
