...
Internal URLs in files are automatically masked to placeholders (e.g., `https://internal.example.com/path` → `https://[MASKED-abc123].invalid/path`). This prevents URL corruption from the LLM proxy.

**What you need to know:**
- When reading files, you'll see placeholder URLs — this is expected
- When editing/writing, use the placeholder URLs you see — the hook restores them automatically
- Don't try to "fix" or decode placeholder URLs
